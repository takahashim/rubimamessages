...
Ruby とは関係ない書籍についてのガイドを作ってみた ( @<href>{http://oss.sios.com/guest-blog/guest-bog-20150318} ) ので、
...
『Ruby on Rails チュートリアル』( @<href>{http://railstutorial.jp/} ) が真っ先に思いつく。
...
行っている。RHG はオンライン版が公開されている (http://i.loveruby.net/ja/rhg/book/ ) ので、興味のある方はぜひとも読み比べてみることを勧めたい。
...
なお、『恋するプログラム― Ruby でつくる人工無脳』は一時期入手困難だったのだが、現在は版元サイトより受注生産 (!) で入手できるのと、電子書籍でも入手できるようになっている。 @<href>{https://book.mynavi.jp/ec/products/detail/id=33771}

応用とはちょっと違った形になるが、Ruby を通してコンピュータ・サイエンスを学ぶ
『アンダースタンディング コンピュテーション―単純な機械から不可能なプログラムまで』
がある。本書は@<href>{http://magazine.rubyist.net/?0048, Rubyist Magazine 0048 号}にてすでに紹介済み (@<href>{http://magazine.rubyist.net/?0048-BookUC_ja,書籍紹介『アンダースタンディング コンピュテーション――単純な機械から不可能なプログラムまで』}) なので
...
@<href>{https://book.mynavi.jp/ec/products/detail/id=24268}
